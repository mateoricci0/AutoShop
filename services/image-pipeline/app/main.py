"""Image Pipeline Service — generates product images and stores them in MinIO."""
...
configure_logging("image-pipeline")
...
app = FastAPI(
    title="ASE Image Pipeline",
    description="Generates product images via DALL-E / Stability AI and stores them in MinIO.",
    version="0.1.0",
    lifespan=lifespan,
)
